...
Асинхронных вызовов в системе нет. Управление всегда идёт от сервера к датчику.
Код приложения имеет сильную связанность.

### 3. Определение доменов и границы контекстов

Домены:

1. Управление устройствами (управление жизненным циклом устройства)
